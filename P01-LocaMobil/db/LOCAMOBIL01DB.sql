...
CREATE TABLE MODELO(
	...
	NOME_MODELO VARCHAR(512) NOT NULL,
...
CREATE TABLE VEICULO(
	...
	CONSTRAINT FK_MODELO FOREIGN KEY(ID_MODELO) REFERENCES MONTADORA(ID_MODELO),
	CONSTRAINT FK_CATEGORIA FOREIGN KEY(ID_CATEGORIA) REFERENCES MONTADORA(ID_CATEGORIA),
...
CREATE TABLE LOCACAO(
	ID_LOCACAO INTEGER CONSTRAINT PK_CLIENTE PRIMARY KEY AUTOINCREMENT NOT NULL,
...
CREATE TABLE DEVOLUCAO(
	ID_DEVOLUCAO INTEGER CONSTRAINT PK_CLIENTE PRIMARY KEY AUTOINCREMENT NOT NULL,
	DATA_DEVOLUCAO DATE NOT NULL,
...
CREATE TABLE BAIXA(
	ID_BAIXA INTEGER CONSTRAINT PK_CLIENTE PRIMARY KEY AUTOINCREMENT NOT NULL,
...
INSERT INTO USUARIO(NOME_USUARIO, LOGIN, SENHA, ADMINISTRADOR, ATIVO) VALUES('Admin','admin','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec',1,1);
INSERT INTO USUARIO(NOME_USUARIO, LOGIN, SENHA, ADMINISTRADOR, ATIVO) VALUES('User','user','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec',1,0);
INSERT INTO USUARIO(NOME_USUARIO, LOGIN, SENHA, ADMINISTRADOR, ATIVO) VALUES('Bool','bool','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec',1,2);
INSERT INTO USUARIO(NOME_USUARIO, LOGIN, SENHA, ADMINISTRADOR, ATIVO) VALUES('Usuario','usuario','c7ad44cbad762a5da0a452f9e854fdc1e0e7a52a38015f23f3eab1d80b931dd472634dfac71cd34ebc35d16ab7fb8a90c81f975113d6c7538dc69dd8de9077ec',0,1);
